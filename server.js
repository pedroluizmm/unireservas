...
app.put('/api/reservas/:id', async (req, res) => {
  const { horario, numPessoas, preferenciaLocalizacao, statusPagamento } = req.body;
  const id = req.params.id;
  if (!horario && !numPessoas && !preferenciaLocalizacao && !statusPagamento) {
  ...
  try {
    await query(
      ...
      [horario, numPessoas, preferenciaLocalizacao, statusPagamento, id]
    );
    res.json({ id, horario, numPessoas, preferenciaLocalizacao, statusPagamento });
  } catch (err) {
    console.error(err);
